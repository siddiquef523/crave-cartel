...
import { StoreStatusProvider } from "@/lib/store-status";
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          This page isn't on the menu. Let's get you back to the good stuff.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Crave Cartel" },
      ...
      { name: "twitter:title", content: "Crave Cartel — Bold Flavours. Fast Pickup." },
      {
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/30d8e243-6b77-4560-b2e5-f6fd73bd264c/id-preview-43f86b7f--140bddc8-9f57-413e-8d5b-f09dc47a0df3.lovable.app-1785128709498.png",
      },
      {
        name: "twitter:image",
        content:
