-- =====================================================================
-- CRAVE CARTEL — MASTER DATABASE SETUP SCRIPT (CLEANED & COMBINED)
-- Includes: All Tables, RLS Policies, Storage, Triggers & Order Type Fix
-- =====================================================================
...
-- FIXED & UNIFIED ORDER TYPE CONSTRAINT
...
-- ---------------------------------------- INVENTORY STOCK FUNCTIONS & TRIGGERS
